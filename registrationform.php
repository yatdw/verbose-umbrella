	...
	<div class="col-md-4"><label>Academic Year: <?php echo $_SESSION['SY'] ; ?></label></div>
		<table class="table">
			...
			<tr>
				...
				<td colspan="5"  >
				<input required="true"  class="form-control input-md" id="email" name="email" placeholder="Email Address" type="text" value="<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : ''; ?>">
				</td> 
			</tr>
			<tr>
