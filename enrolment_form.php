...
if($q=='enrol'){   
  if(isset($_SESSION['IDNO'])){ 
    ...
    if ($stud->NewEnrollees == 1) {
     ...
     }elseif($stud->student_status=='Transferee'){
         redirect('index.php?q=profile');
     }else{
         redirect('index.php?q=profile');
     }
...
<ul class="nav nav-tabs" id="myTab">
    ...
    <li class="activate"><a href="#Transferees" data-toggle="tab">Transferees</a></li>
  </ul>
  <div class="tab-content"><br/>
    <div class="tab-pane active" id="New">
     ...
     <div class="tab-pane" id="Old">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
              <div class="well well-sm"  style="background-color:#eb280b;color:#fff;"><b >  Login </b> </div>
                  ...
                  <form class="form-horizontal span6" action="login.php" method="POST">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <div class="col-md-12"> 
                          <button type="submit" id="oldLogin" name="oldLogin"  style="background-color:#eb280b;color:#fff;" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-logged-in "></span>   Login</button> 
     ...
     <div class="tab-pane activate" id="Transferees"><br/> 
