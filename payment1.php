...
$TOTUNITS = $_POST['SUBTOT'];
$ENTRANCEFEE = $_POST['ENTRANCEFEE'];
$TOTSEM = $_POST['TOTSEM'];
$PARTIAL = $_POST['PartialPayment'];


$query = "SELECT * FROM tblstudent s, course c WHERE s.COURSE_ID=c.COURSE_ID AND IDNO=".$_POST['IDNO'];
...
if ($row['student_status']=='Irregular') {
		...
		foreach ($cur as $result) { 
			...
			$studentsubject->LEVEL 		= $_POST['COURSELEVEL'];
			$studentsubject->SEMESTER 	= $_POST['SEMESTER'];
		...
		if (isset($_SESSION['gvCart'])) {
      	...
      	$sql = "SELECT * FROM course WHERE COURSE_NAME='" .$_POST['Course_name']. "' AND COURSE_LEVEL =".$_POST['COURSELEVEL'];
      	$result = mysqli_query($mydb->conn,$sql) or die(mysqli_error($mydb->conn));
      	$row = mysqli_fetch_assoc($result);

		$mydb->setQuery("SELECT * FROM `subject` s, `course` c 
			WHERE s.COURSE_ID=c.COURSE_ID AND c.COURSE_ID=".$row['COURSE_ID']." AND SEMESTER='".$_POST['SEMESTER']."'");
	...
	$sql = "INSERT INTO `schoolyr`
	    ...
	    VALUES ('".$_POST['SY']."','".$_POST['SEMESTER']."','".$_POST['COURSEID']."','".$_POST['IDNO']."','ENROLLED','".date('Y-m-d')."','".date('Y-m-d')."','Old');";
	...
	$sql = "INSERT INTO `tblpayment`
	 ...
	 VALUES(".$_POST['IDNO'].",".$COURSEID.",".$COURSELEVEL.",'".$SEMESTER."','".$ENTRANCEFEE."','".$TOTUNITS."','".$TOTSEM."','".@$PARTIAL."','".@$txtBalance."')";
	 $res = mysqli_query($mydb->conn,$sql) or die(mysqli_error($mydb->conn));
...
<div class="table-responsive">
		<table class="table">
			<tr>
				...
				<td >
					<input class="form-control input-md" id="IDNO" name="IDNO" placeholder="Student Id" type="int">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				...
				<td >
					<input class="form-control input-md" id="COURSEID" name="COURSEID" placeholder="Course" type="int">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				...
				<td >
					<input class="form-control input-md" id="COURSELEVEL" name="COURSELEVEL" placeholder="Year" type="int">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				...
				<td >
					<input class="form-control input-md" id="SEMESTER" name="SEMESTER" placeholder="Course" type="text">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				...
				<td >
					<input class="form-control input-md" id="SUBTOT" name="SUBTOT" placeholder="Course" type="int">
				</td>
				<td colspan="4"></td>

			</tr>
			<tr>
				<td><label>Entrance Fee</label></td>
				<td >
					<input class="form-control input-md" id="ENTRANCEFEE" name="ENTRANCEFEE" placeholder="Course" type="int">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				<td><label>SEMESTER</label></td>
				<td >
					<input class="form-control input-md" id="TOTSEM" name="TOTSEM" placeholder="Course" type="int">
				</td>
				<td colspan="4"></td>

			</tr>
			<tr>
				<td><label>PartialPayment</label></td>
				<td >
					<input class="form-control input-md" id="PartialPayment" name="PartialPayment" placeholder="Course" type="int">
				</td>
				<td colspan="4"></td>
			...
			<tr>
				...
				<td >
					<input class="form-control input-md" id="SY" name="SY" placeholder="Course" type="int">
				</td>
				<td colspan="4"></td>
